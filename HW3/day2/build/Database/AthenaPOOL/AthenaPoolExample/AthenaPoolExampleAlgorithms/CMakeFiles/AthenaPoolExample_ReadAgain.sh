...
#
# This script is used by CTest to run the test AthenaPoolExample_ReadAgain with the correct
...
export ATLAS_CTEST_TESTNAME='AthenaPoolExample_ReadAgain'
...
# Run the test:
/home/shadhm/c2thep2_Submissions/HW3/day2/build/Database/AthenaPOOL/AthenaPoolExample/AthenaPoolExampleAlgorithms/test-bin/AthenaPoolExample_ReadAgain.exe 2>&1 | tee AthenaPoolExample_ReadAgain.log
...
if [ -f /home/shadhm/c2thep2_Submissions/HW3/day2/athena/Database/AthenaPOOL/AthenaPoolExample/AthenaPoolExampleAlgorithms/share/AthenaPoolExample_ReadAgain.ref ] &&
    ...
    /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.29.5/Linux-x86_64/bin/cmake -E create_symlink \
     /home/shadhm/c2thep2_Submissions/HW3/day2/athena/Database/AthenaPOOL/AthenaPoolExample/AthenaPoolExampleAlgorithms/share/AthenaPoolExample_ReadAgain.ref ../share/AthenaPoolExample_ReadAgain.ref
fi
...
if type post.sh >/dev/null 2>&1; then
    post.sh AthenaPoolExample_ReadAgain  -i 'Warning in <TFile::Init>: no StreamerInfo found|BYTES_READ|READ_CALLS|DEBUG lookupPFN|DEBUG registered PFN|XMLCatalog +INFO|Found address:|DEBUG.*ThinningCacheTool|DEBUG setAttribute|DEBUG Failed to find TTree:.*to set POOL property|DEBUG.*failed process POOL.*attributes.|metadataItemList|Creating branch for new dynamic|::getBranchInfo|Cache alignment|DEBUG index_ref|DEBUG EventInfo'
else
    exit $testStatus
fi
