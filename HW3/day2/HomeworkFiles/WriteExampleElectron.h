...
class WriteExampleElectron : public AthReentrantAlgorithm {
 ...
 public:
  ...
  SG::WriteDecorHandleKey<xAOD::ExampleElectronContainer> m_decor_longdoubleKey{
      this, "ExampleElectronContainerDecorKeyLongDouble", "TestContainer.decor_longdouble","decorator for long double key"};
 
  SG::WriteDecorHandleKey<xAOD::ExampleElectronContainer> m_decor_HaydenKey{
    this, "ExampleElectronContainerDecorKeyHayden", "TestContainer.decor_Hayden",
    "decorator for my favorite data type - double"};
